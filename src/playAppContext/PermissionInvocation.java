...
public class PermissionInvocation
{
  ...
  public PermissionInvocation(SootMethod src, SootMethod tgt, String permission)
  {
     this.src = src;
     this.tgt = tgt;
  ...
  public SootMethod getSrc()
  {
   ...
   public void setSrc(SootMethod src) { this.src = src; }
  
  public SootMethod getTgt() {
     return tgt;
  }
  
   public void setTgt(SootMethod tgt) { this.tgt = tgt; }
  ...
  public boolean equals(Object obj)
  {
     ...
     if ((getSrc().equals(invoc.getSrc())) && (getTgt().equals(invoc.getTgt()))) return true;
     return false;
  }
}
